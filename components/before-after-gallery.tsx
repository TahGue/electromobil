...
const images = [
  {
    ...
    caption: "iPhone 13 Screen • 45 min",
  },
  {
    ...
    caption: "Samsung Battery • 40 min",
  },
  {
          ...
          {images.map((img, idx) => (
            ...
            >
              <div className="grid grid-cols-2">
                <img src={img.before} alt="Before" className="aspect-[4/3] w-full object-cover" />
                <img src={img.after} alt="After" className="aspect-[4/3] w-full object-cover" />
              </div>
          ...
          <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4" onClick={() => setOpen(null)}>
            <div className="max-w-3xl w-full bg-white rounded-lg overflow-hidden" onClick={(e) => e.stopPropagation()}>
              <div className="grid grid-cols-1 md:grid-cols-2">
                <img src={images[open].before} alt="Before" className="w-full h-full object-cover" />
                <img src={images[open].after} alt="After" className="w-full h-full object-cover" />
              </div>
